...
if (isset($_SESSION['user_login'])) {
	...
	$stmt1 = $db->query("SELECT * FROM sp03 WHERE user_id = $id");
    $stmt1->execute();
    $row1 = $stmt1->fetch(PDO::FETCH_ASSOC);

    $stmt2 = $db->query("SELECT * FROM sp031 WHERE user_id = $id");
    $stmt2->execute();
    $row2 = $stmt2->fetch(PDO::FETCH_ASSOC);

    $stmt3 = $db->query("SELECT * FROM enterprise WHERE user_id = $id");
    $stmt3->execute();
    $row3 = $stmt3->fetch(PDO::FETCH_ASSOC);

    $stmt4 = $db->query("SELECT * FROM sp03e WHERE user_id = $id");
    $stmt4->execute();
    $row4 = $stmt4->fetch(PDO::FETCH_ASSOC);

    $stmt5 = $db->query("SELECT * FROM sp03l WHERE user_id = $id");
    $stmt5->execute();
...
$html10 = '<div style="position:absolute;top:600px;left:330px">'.$row1['cardno'].'</div>';
...
$html50 = '<div style="position:absolute;top:480px;left:185px;width:150px;">'.$row4['school1'].'</div>';
$html51 = '<div style="position:absolute;top:505px;left:185px;width:150px;">'.$row4['school2'].'</div>';
$html52 = '<div style="position:absolute;top:530px;left:185px;width:150px;">'.$row4['school3'].'</div>';
$html53 = '<div style="position:absolute;top:555px;left:185px;width:150px;">'.$row4['school4'].'</div>';
$html54 = '<div style="position:absolute;top:580px;left:185px;width:150px;">'.$row4['school5'].'</div>';

$html55 = '<div style="position:absolute;top:480px;left:370px;width:150px;">'.$row4['year_att1'].'</div>';
$html56 = '<div style="position:absolute;top:505px;left:370px;width:150px;">'.$row4['year_att2'].'</div>';
$html57 = '<div style="position:absolute;top:530px;left:370px;width:150px;">'.$row4['year_att3'].'</div>';
$html58 = '<div style="position:absolute;top:555px;left:370px;width:150px;">'.$row4['year_att4'].'</div>';
$html59 = '<div style="position:absolute;top:580px;left:370px;width:150px;">'.$row4['year_att5'].'</div>';

$html60 = '<div style="position:absolute;top:480px;left:430px;width:150px;">'.$row4['year_grad1'].'</div>';
$html61 = '<div style="position:absolute;top:505px;left:430px;width:150px;">'.$row4['year_grad2'].'</div>';
$html62 = '<div style="position:absolute;top:530px;left:430px;width:150px;">'.$row4['year_grad3'].'</div>';
$html63 = '<div style="position:absolute;top:555px;left:430px;width:150px;">'.$row4['year_grad4'].'</div>';
$html64 = '<div style="position:absolute;top:580px;left:430px;width:150px;">'.$row4['year_grad5'].'</div>';

$html65 = '<div style="position:absolute;top:480px;left:500px">'.$row4['certificate1'].'</div>';
$html66 = '<div style="position:absolute;top:505px;left:500px">'.$row4['certificate2'].'</div>';
$html67 = '<div style="position:absolute;top:530px;left:500px">'.$row4['certificate3'].'</div>';
$html68 = '<div style="position:absolute;top:555px;left:500px">'.$row4['certificate4'].'</div>';
$html69 = '<div style="position:absolute;top:580px;left:500px">'.$row4['certificate5'].'</div>';

$html70 = '<div style="position:absolute;top:480px;left:650px;width:150px;">'.$row4['major1'].'</div>';
$html71 = '<div style="position:absolute;top:505px;left:650px;width:150px;">'.$row4['major2'].'</div>';
$html72 = '<div style="position:absolute;top:530px;left:650px;width:150px;">'.$row4['major3'].'</div>';
$html73 = '<div style="position:absolute;top:555px;left:650px;width:150px;">'.$row4['major4'].'</div>';
$html74 = '<div style="position:absolute;top:580px;left:650px;width:150px;">'.$row4['major5'].'</div>';

$html75 = '<div style="position:absolute;top:705px;left:300px;width:150px;">'.$row5['listen1'].'</div>';
$html76 = '<div style="position:absolute;top:728px;left:300px;width:150px;">'.$row5['listen2'].'</div>';
$html77 = '<div style="position:absolute;top:750px;left:300px;width:150px;">'.$row5['listen3'].'</div>';

$html78 = '<div style="position:absolute;top:705px;left:450px;width:150px;">'.$row5['speaking1'].'</div>';
$html79 = '<div style="position:absolute;top:728px;left:450px;width:150px;">'.$row5['speaking2'].'</div>';
$html80 = '<div style="position:absolute;top:750px;left:450px;width:150px;">'.$row5['speaking3'].'</div>';

$html81 = '<div style="position:absolute;top:705px;left:630px;width:150px;">'.$row5['writing1'].'</div>';
$html82 = '<div style="position:absolute;top:728px;left:630px;width:150px;">'.$row5['writing2'].'</div>';
$html83 = '<div style="position:absolute;top:750px;left:630px;width:150px;">'.$row5['writing3'].'</div>';

$html84 = '<div style="position:absolute;top:750px;left:230px;width:150px;">'.$row5['orther'].'</div>';
$mpdf->WriteHTML($html34);
...
$mpdf->WriteHTML($html75);
$mpdf->WriteHTML($html76);
$mpdf->WriteHTML($html77);
$mpdf->WriteHTML($html78);
$mpdf->WriteHTML($html79);
$mpdf->WriteHTML($html80);
$mpdf->WriteHTML($html81);
$mpdf->WriteHTML($html82);
$mpdf->WriteHTML($html83);
$mpdf->Output();
