...
if (isset($_REQUEST['btn_update'])) {
    try {
        ...
        $result = ($d01+$d02+$d03+$d04+$d05+$d06+$d07+$d08+$d09+$d10+$d11+$d12+$d13+$d14)/100;

        if (!isset($errorMsg)) {
           
            $insert_stmt = $db->prepare('INSERT INTO sp15(user_id,name015,studentid015,branch015,faculty015,name115,name215,rank215,department215,name315,name415,d01
            ,d02,d03,d04,d05,d06,d07,d08,d09,d10,d11,d12,d13,d14,result) 
            VALUES (:id,:name015,:studentid015,:branch015,:faculty015,:name115,:name215,:rank215,:department215,:name315,:name415,:d01,:d02,:d03,:d04,:d05,:d06,:d07,:d08,:d09,:d10,:d11
            ,:d12,:d13,:d14,:result)');

            $insert_stmt->bindParam(':name015', $name015);
            $insert_stmt->bindParam(':studentid015', $studentid015);
            $insert_stmt->bindParam(':branch015', $branch015);
            $insert_stmt->bindParam(':faculty015', $faculty015);
            $insert_stmt->bindParam(':name115', $name115);
            $insert_stmt->bindParam(':name215', $name215);
            $insert_stmt->bindParam(':rank215', $rank215);
            $insert_stmt->bindParam(':department215', $department215);
            $insert_stmt->bindParam(':name315', $name315);
            $insert_stmt->bindParam(':name415', $name415);
