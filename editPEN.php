...
if (!isset($_SESSION['user_login'])) {
    ...
    if (isset($_REQUEST['btn_update'])) {
        try {
            ...
            if (!isset($errorMsg)) {
                $update_stmt = $db->prepare("UPDATE enterpriseusers SET nameenterprise = :name_up WHERE id = :id");
...
<body>
    ...
    <div class="container text-center">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" name="fullname" class="form-control" value="<?php echo $row['nameenterprise']; ?>">
            </div>
            </div>
        </div>
