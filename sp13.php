...
if (isset($_REQUEST['btn_update'])) {
    try {
        ...
        if (!isset($errorMsg)) {
            ...
            $insert_stmt = $db->prepare('INSERT INTO sp13(user_id,name013,studentid013,branch013,faculty013,name113,name213,rank213,department213,d01,d02,d03,d04,d05,d06,d07,d08,d09,d10,d11,d12,d13,d14,d15,d16,d17,d18,d19,d20) 
            VALUES (:id,:name013,:studentid013,:branch013,:faculty013,:name113,:name213,:rank213,:department213,:d01,:d02,:d03,:d04,:d05,:d06,:d07,:d08,:d09,:d10,:d11,:d12,:d13,:d14,:d15,:d16,:d17,:d18,:d19,:d20)');

            $insert_stmt->bindParam(':name013', $name013);
            $insert_stmt->bindParam(':studentid013', $studentid013);
            $insert_stmt->bindParam(':branch013', $branch013);
            $insert_stmt->bindParam(':faculty013', $faculty013);
            $insert_stmt->bindParam(':name113', $name113);
            $insert_stmt->bindParam(':name213', $name213);
            $insert_stmt->bindParam(':rank213', $rank213);
            $insert_stmt->bindParam(':department213', $department213);
...
<section class="bg-light w-100">
    <div class="container py-5">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="name013" >
        </div>
        <div class="mb-3">
            <label for="fullname" class="form-label">รหัสประจำตัว </label>
            <input type="text" class="form-control" name="studentid013" >
        </div>
        <div class="mb-3">
            <label for="fullname" class="form-label">สาขาวิชา</label>
            <input type="text" class="form-control" name="branch013" >
        </div>
        <div class="mb-3">
            <label for="fullname" class="form-label">คณะ / วิทยาลัย</label>
            <input type="text" class="form-control" name="faculty013">
        </div>
        <div class="mb-3">
            <label for="fullname" class="form-label">ชื่อสถานประกอบการ </label>
            <input type="text" class="form-control" name="name113" >
        </div>
        <div class="mb-3">
            <label for="fullname" class="form-label">ชื่อ-นามสกุลผู้ประเมิน </label>
            <input type="text" class="form-control" name="name213" >
        </div>
        <div class="mb-3">
            <label for="fullname" class="form-label">ตำแหน่ง</label>
            <input type="text" class="form-control" name="rank213" >
        </div>
        <div class="mb-3">
            <label for="fullname" class="form-label">แผนก/ฝ่าย </label>
            <input type="text" class="form-control" name="department213">
        </div>
        <hr> 
