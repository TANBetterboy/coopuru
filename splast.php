  ...
  <h1>กรอกเอกสาร</h1>
            ...
            <div class="row gy-1 g-lg-1 mb-1">
                ...
                <div class="col-md-4 mb-1">
                    <a href="sp07.php" class="recent-work card border-1 shadow-lg overflow-hidden">
                ...
                <!-- Start Recent Work -->
                <div class="col-md-4 mb-1">
                    <a href="sp08.php" class="recent-work card border-1 shadow-lg overflow-hidden">
                ...
                <!-- Start Recent Work -->
                <div class="col-md-4 mb-1">
                    <a href="sp09.php" class="recent-work card border-1 shadow-lg overflow-hidden">
        ...
        <a href="spfirst.php?hour=<?php echo $row['hoursactivity'];?>" class="banner-button btn rounded-pill btn-outline-primary btn-lg px-4 recent-work card border-5 shadow-lg py-3">ขั้นตอนสมัครสหกิจศึกษา</a>
        <h1>ดาวน์โหลดเอกสาร</h1>
        <div class="row gy-1 g-lg-1 mb-1">

                <!-- Start Recent Work -->
                <div class="col-md-4 mb-1">
                    <a href="sp07pdf.php?id=<?php echo $user_id?>" class="recent-work card border-1 shadow-lg overflow-hidden">
                        <img class="recent-work-img card-img" src="images/sp07.png" alt="Card image">
                        <div class="recent-work-vertical card-img-overlay d-flex align-items-end">
                            <div class="recent-work-content text-start mb-3 ml-3 text-dark">
                ...
                <!-- Start Recent Work -->
                <div class="col-md-4 mb-1">
                    <a href="sp08pdf.php?id=<?php echo $user_id?>" class="recent-work card border-1 shadow-lg overflow-hidden">
                        <img class="recent-work-img card-img" src="images/sp08.png" alt="Card image">
                        <div class="recent-work-vertical card-img-overlay d-flex align-items-end">
                            <div class="recent-work-content text-start mb-3 ml-3 text-dark">
                ...
                <!-- Start Recent Work -->
                <div class="col-md-4 mb-1">
                    <a href="sp09pdf.php?id=<?php echo $user_id?>" class="recent-work card border-1 shadow-lg overflow-hidden">
                        <img class="recent-work-img card-img" src="images/sp09.png" alt="Card image">
                        <div class="recent-work-vertical card-img-overlay d-flex align-items-end">
                            <div class="recent-work-content text-start mb-3 ml-3 text-dark">
