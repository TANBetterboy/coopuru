...
<body>
 ...
 <script src="assets/js/bootstrap.bundle.min.js"></script>
    ...
    <div class="recent-work-header row text-center  text-light ">
                <h2 class="h2 semi-bold-600 py-5">เว็บไซต์สำหรับอาจารย์ที่ปรึกษา ยินดีต้อนรับ</h2> 
    </div>
    <div class="recent-work-header row text-center  text-light">
 ...
 <h1>ข้อมูลส่วนตัวของนักศึกษา</h1>  <h3>สาขา :<?php echo $branch ?></h3>
    ...
    <thead class="table-dark">
      <tr>
        ...
        <th>ดูเอกสารสก.ของนักศึกษา</th>
          ...
          <?php 
$query=mysqli_query($con,"Select * from users where branch='$branch'");
...
?>
    <tbody>
      ...
      <td>
        <a class="btn btn-primary"href="datastudent3.php?id=<?php echo htmlentities($row1['id']);?>">ข้อมูลส่วนตัวของนักศึกษา</a>
    </td>
    <td>
        <a class="btn btn-primary"href="dataspstudent3.php?id=<?php echo htmlentities($row1['id']);?>">ข้อมูลเอกสารสก</a>
    </td>
...
<?php
$query=mysqli_query($con,"Select users.fullname,enterprise.name0 from users,enterprise where users.branch='$branch'&&enterprise.user_id=users.id ");
