											...
											<div class="demo-box m-t-20">
												...
												<div class="table-responsive">
                                                    <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($con,"Select tblcomments.id,tblcomments.fullname,tblcomments.faculty,tblcomments.postingDate,tblcomments.studentid,tblposts.id as postid,tblposts.PostTitle,tblposts.hourspost,tblcomments.user_id,users.hoursactivity from  tblcomments join tblposts on tblposts.id=tblcomments.postId join users on users.id=tblcomments.user_id where tblcomments.status=0");
$cnt=1;
...
?>
 ...
 <tr>
    ...
    <?php else :?>  
    <a href="unapprove-comment.php?appid=<?php echo htmlentities($row['id']);?> &&hourspost=<?php echo htmlentities($row['hourspost']);?> &&user_id=<?php echo htmlentities($row['user_id']);?> &&hoursactivity=<?php echo htmlentities($row['hoursactivity']);?>&&pid=<?php echo htmlentities($row['postid']);?>" title="Approve this comment"><i class="ion-arrow-return-right" style="color: #29b6f6;"></i></a>
    <?php endif;?>
    </td>
