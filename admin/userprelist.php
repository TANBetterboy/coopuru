                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">รายชื่อผู้ใช้งานระบบสหกิจศึกษา</h4>
										...
										<div class="col-md-12">
											<div class="demo-box m-t-20">
                                                ...
                                                <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($con,"Select * from  users  where hoursactivity>1");
$cnt=1;
...
<td><?php echo htmlentities($row['hoursactivity']);?></td>
