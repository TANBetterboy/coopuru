 ...
 <nav id="main_nav" class="navbar navbar-expand-lg navbar-light bg-white shadow">
    ...
    <div class="container text-center">
        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                <?php 
                    $select_stmt = $db->prepare("SELECT * FROM sp12a WHERE user_id = $user_id"); 
                    $select_stmt->execute();
                    while ($row1 = $select_stmt->fetch(PDO::FETCH_ASSOC)) {
                ?>
                    <tr>
                        <td><img src="upload/sp12/<?php echo $row1['image1']; ?>" width="100px" height="100px" alt=""></td>                        
                        <td><img src="upload/sp12/<?php echo $row1['image2']; ?>" width="100px" height="100px" alt=""></td> 
                        <td><a href="sp12upedit.php?update_id=<?php echo $row1['id']; ?>" class="btn btn-warning">Edit</a></td>                        
                        <td><a href="spimg.php?delete_id=<?php echo $row1['id']; ?>&&action=del1" class="btn btn-danger">Delete</a></td>                       
                    </tr>
                <?php } ?>
            </tbody>
        </table>
    ...
    <!-- close table -->
     ...
     <div class="container text-center">
        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                <?php 
                    $select_stmt = $db->prepare("SELECT * FROM sp15a WHERE user_id = $user_id"); 
                    $select_stmt->execute();
                    while ($row4 = $select_stmt->fetch(PDO::FETCH_ASSOC)) {
                ?>
                    <tr>
                        <td><img src="upload/sp15/<?php echo $row4['image1']; ?>" width="100px" height="100px" alt=""></td>                        
                        <td><img src="upload/sp15/<?php echo $row4['image2']; ?>" width="100px" height="100px" alt=""></td>      
                        <td><a href="sp15upedit.php?update_id=<?php echo $row4['id']; ?>" class="btn btn-warning">Edit</a></td>                        
                        <td><a href="spimg.php?delete_id=<?php echo $row4['id']; ?>&&action=del4" class="btn btn-danger">Delete</a></td>                      
                    </tr>
                <?php } ?>
            </tbody>
        </table>
