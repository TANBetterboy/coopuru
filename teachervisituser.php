...
<body>
 ...
 <nav id="main_nav" class="navbar navbar-expand-lg navbar-light bg-white shadow">
        <div class="container d-flex justify-content-between align-items-center">
            <a class="navbar-brand h1" href="teachervisituser.php">
...
<script src="assets/js/bootstrap.bundle.min.js"></script>
    ...
    <div class="recent-work-header row text-center  text-light ">
                <h2 class="h2 semi-bold-600 py-5">เว็บไซต์สำหรับอาจารย์นิเทศ ยินดีต้อนรับ</h2> 
    </div>
    <div class="recent-work-header row text-center  text-light">
...
<div class="col-md-4 mb-1">
    <a href="sp12.php" class="recent-work card border-1 shadow-lg overflow-hidden">
        <img class="recent-work-img card-img" src="images/12b.png" alt="Card image">
...
<!-- Start Recent Work -->
<div class="col-md-4 mb-1">
    <a href="sp12up.php" class="recent-work card border-1 shadow-lg overflow-hidden">
        <img class="recent-work-img card-img" src="images/12a.png" alt="Card image">
        <div class="recent-work-vertical card-img-overlay d-flex align-items-end">
            <div class="recent-work-content text-start mb-3 ml-3 text-dark">
...
<!-- Start Recent Work -->
<div class="col-md-4 mb-1">
<a href="sp15.php" class="recent-work card border-1 shadow-lg overflow-hidden">
    <img class="recent-work-img card-img" src="images/15b.png" alt="Card image">
    <div class="recent-work-vertical card-img-overlay d-flex align-items-end">
        <div class="recent-work-content text-start mb-3 ml-3 text-dark">
...
<!-- Start Recent Work -->
<div class="col-md-4 mb-1">
<a href="sp15up.php" class="recent-work card border-1 shadow-lg overflow-hidden">
    <img class="recent-work-img card-img" src="images/15a.png" alt="Card image">
    <div class="recent-work-vertical card-img-overlay d-flex align-items-end">
        <div class="recent-work-content text-start mb-3 ml-3 text-dark">
...
<!-- Start Recent Work -->
<div class="col-md-4 mb-1">
<a href="spteac.php" class="recent-work card border-1 shadow-lg overflow-hidden">
...
<!-- Start Recent Work -->
<div class="col-md-4 mb-1">
<a href="spimg.php" class="recent-work card border-1 shadow-lg overflow-hidden">
